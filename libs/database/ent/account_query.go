...
func (aq *AccountQuery) QueryWallet() *WalletQuery {
	query := &WalletQuery{config: aq.config}
...
func (aq *AccountQuery) loadWallet(ctx context.Context, query *WalletQuery, nodes []*Account, init func(*Account), assign func(*Account, *Wallet)) error {
